...
pub mod polymarket {
    pub mod wallet_factory {
        // @@protoc_insertion_point(attribute:polymarket.wallet_factory.v1)
        pub mod v1 {
            include!("polymarket.wallet_factory.v1.rs");
            // @@protoc_insertion_point(polymarket.wallet_factory.v1)
        }
    }
}
pub mod sf {
