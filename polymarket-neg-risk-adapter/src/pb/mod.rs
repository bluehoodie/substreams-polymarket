...
pub mod polymarket {
    pub mod neg_risk_adapter {
        // @@protoc_insertion_point(attribute:polymarket.neg_risk_adapter.v1)
        pub mod v1 {
            include!("polymarket.neg_risk_adapter.v1.rs");
            // @@protoc_insertion_point(polymarket.neg_risk_adapter.v1)
        }
    }
}
pub mod sf {
